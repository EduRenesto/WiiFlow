...
protected:
	...
	static constexpr const float fBannerWidth = 608.f;
	static constexpr const float fBannerHeight = 448.f;
	static constexpr const float fIconWidth = 128.f;
	static constexpr const float fIconHeight = 96.f;
